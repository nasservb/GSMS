...
Class jCalendar {
	...
	*/
	...
	{
		GSMS::$class['system_log']->log('DEBUG','calendar class Initialized');
	}
	public function now()
	{
		//date_default_timezone_set('Asia/Tehran');
		return $this->date(GSMS::$config['date_format'],time(),GSMS::$config['date_gmt']) ;
	}//fun
	...
	*/
	...
	public function fa2en($time)
	{
		...
		$out=$date[0].'-'.$date[1].'-'.$date[2].' '.$hour.$min.$sec;
	}//func
