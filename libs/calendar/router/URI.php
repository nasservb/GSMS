...
//uri is used in router .it's work on adress location and process any web request on model layer start 5-2-91 by nasser niazy in gooya smslearning system
...
class CI_URI {
	...
	public function __construct()
	{
		...
		GSMS::$class['system_log']->log('debug', "URI Class Initialized");
	}
	// --------------------------------------------------------------------
