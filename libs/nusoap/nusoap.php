...
// server class
require_once('class.soapserver.php');*/
...
/**
*
* soapserver allows the user to create a SOAP server
...
* @access   public
*/
class soapserver extends nusoap_base {
	...
	* @access   public
	*/
	function soapserver($wsdl=false){
		...
		// wsdl
		if($wsdl){
			if (is_object($wsdl) && is_a($wsdl, 'wsdl')) {//wsdl is an object
				$this->wsdl = $wsdl;
		...
		self::$class['system_log']->log('DEBUG','the soapserver class is Initilized');
	}//fun
...
class soapclient extends nusoap_base  {
	...
	*/
	function soapclient($endpoint,$wsdl = false,$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30){
		...
		self::$class['system_log']->log('DEBUG','the soapclient class is Initilized');
	}//func
