				...
				<div class="sidebar-wrapper">
					<ul class="nav">
						<li class="<?=($info['activeTab']=='dashboard'? 'active' : '')?>">
							<a href="<?php echo $info['user_url']; ?>">
								<i class="material-icons">unarchive</i>
								<p>داشبورد</p>
							</a>
						</li>
						<li class="<?=($info['activeTab']=='orders'? 'active' : '')?>">
							<a href="<?php echo $info['user_url']; ?>orders">
								<i class="material-icons">content_paste</i>
								<p>سفارش ها</p>
							</a>
						</li>
						<li class="<?=($info['activeTab']=='accounting'? 'active' : '')?>">
							<a href="<?php echo $info['user_url']; ?>accounting">
								<i class="material-icons">credit_card</i>
								<p>امور مالی</p>
							</a>
						</li>
						<li class="<?=($info['activeTab']=='profile'? 'active' : '')?>">
							<a href="<?php echo $info['user_url']; ?>users">
						...
						<?php
							...
							foreach ($info['user_main_menu'] as $menu  )
							{
