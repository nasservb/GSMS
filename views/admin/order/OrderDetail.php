...
<link href="'.GSMS::$class['template']->info['theme_url'].'css/ticket.css" rel="stylesheet" type="text/css">
								...
								<div class="timeline-badge info"><i class="material-icons">edit</i></div>
									<div class="timeline-panel">
										<div class="timeline-heading">
											<h4 class="timeline-title">'.$userOrder->adminName.'</h4>								
								';
				}
				else 
				{
			...
			$body .= '
					<li class="timeline-inverted">
						...
						<div class="timeline-panel">
						   ...
						   <div class="timeline-body">
							   <p>سفارش توسط '.$userOrder->adminName.' ثبت شد .  </p>
						   </div>
						</div>
					  </li> ';	
		...
		<tbody>
			...
			$body.='
			<div class="col-sm-12">
				<a class="btn btn-success" href="'.GSMS::$class['template']->info['admin_url'].'accounting/viewFacture/'.$userOrder->factureId.'">مشاهده صورحساب مالی  </a>
