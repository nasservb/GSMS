...
class editOption
{
	function editOption($temp)
	{
		$option = $temp['option'];
		$body = '';
		$body .='<div>
		<form method ="POST" action="' . GSMS::$class['template']->info['admin_url'] . 'orderform/editOrderOption/'.$option[0]['id'].'"
		onSubmit="return checkForm()">
			<div class="col-md-6">
				<div class="form-group">
					<label>نام آیتم</label>
					<div class="form-group label-floating is-empty">
						<input class="form-control" name="value" id="value" value="'.$option[0]['value'].'"></input>
		...
		GSMS::$class['template']->message('ویرایش المنت',$body,'admin','',true, false, array('activeTab' => 'orderform'));
