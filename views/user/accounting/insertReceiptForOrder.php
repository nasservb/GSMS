...
class insertReceiptForOrder
{
	function insertReceiptForOrder($temp)
	{
		$inf = array(
		...
		$comment = 'واریز بابت سفارش به شماره' .$userOrder->id;
		...
		<br/>
		<form id="registerForm" method="POST" action ="' . GSMS::$class['template']->info['user_url'] . 
		'accounting/insertReceiptForOrder/'.$userOrder->id.'" 
